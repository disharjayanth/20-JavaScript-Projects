...
// Column allows for item to drop -> by deafault html doesnt allow dropping elements
...
function drop(event) {
  event.preventDefault();
  // Remove background color / padding , when we drag padding gets added to col where we pass also bg changes
  // so we need to remove it
  listColumns.forEach((column) => {
    column.classList.remove("over");
  });
  // Add the item, -> add the dragged item to column
