...
bucketColorBtn.addEventListener('change', () => {
  ...
  createCanvas()
  // For creating new background we are wiping out all with new bg
  // So to get previos drawing we call restoreCanvas() so that it can iterate over array and draw 
  restoreCanvas()
});
...
loadStorageBtn.addEventListener('click', () => {
  if (localStorage.getItem("saveCanvas")) {
    drawnArray = JSON.parse(localStorage.getItem("saveCanvas"));
    restoreCanvas()
    // Active Tool
